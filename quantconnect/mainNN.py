''' neural net algorithm that trades on the month.
takes 30 days lookback and produces single output
adapted from quantconnect template algorithm

to run this, rename the main file to something else
and this file to main.py'''
...
class NeuralNetworkAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        self.SetStartDate(2012, 10, 7)  # Set Start Date
        self.SetEndDate(2014, 12, 8) # Set End Date
